    ...
    render() {
        ...
        if (!this.state.paid) {
            returnHTML = <div>
                ...
                <Modal visible={this.state.visible} width="50%" height="300px" effect="fadeInUp" onClickAway={() => this.closeModal()}>
                    <div className="modal-container">
                        <div className="modal-info-container flex-vertical">
                            ...
                            <div className="modal-info-desc">Gain access to the trade analysis and many more feautres that will be built out before the start of the 2020 season 
                            ...
                            Get in early and help drive which new features are added to help you win. Only $5.</div>
                            <StripeBtn />
                        </div>
